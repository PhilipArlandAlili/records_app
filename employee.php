...
<body>
    ...
    //Create query
    $query = 'SELECT employee.id, employee.lastname, employee.firstname, employee.address, office.name as office_name FROM employee, office WHERE employee.office_id = office.id LIMIT ' . $page_first_result . ',' . $results_per_page;
    //Get result
    $result = mysqli_query($conn, $query);
    //Fetch the data
